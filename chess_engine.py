...
class Board:
    def __init__(self):
        ...
        self.black_promotion = pygame.image.load(".\\assets\\black_promotion.png")
        self.white_promotion = pygame.image.load(".\\assets\\white_promotion.png")
        ...
        for i in range(8):
            ...
            for j in range(8):
                ...
                if i == 0 or i == 7:
                    ...
                    to_append = [(x, y), Pawn(1, ".\\assets\\black_pawn.png")]

                elif i == 6:
                    to_append = [(x, y), Pawn(0, ".\\assets\\white_pawn.png")]
