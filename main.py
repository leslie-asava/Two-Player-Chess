...
def main():
    ...
    checkmate_message = font.render("Checkmate! Press Enter to restart", True, (255, 0, 0))
    stalemate_message = font.render("Stalemate! Press Enter to restart", True, (255, 0, 0))
    draw_message = font.render("Draw! Press Enter to restart", True, (255, 0, 0))
    ...
    def redraw():
        ...
        for line in board.board:
            ...
            for pos, row in line:
                ...
                if (y, x) in moves:
                    pygame.draw.circle(window, (0, 0, 200), (pos[0] + 30, pos[1] + 35), 7)
                x += 1
            y += 1
        ...
        if board.checkmate:
            window.blit(checkmate_message, (50, 300))
        elif board.stalemate:
            window.blit(stalemate_message, (80, 290))
        elif board.draw:
            window.blit(draw_message, (120, 290))
        elif board.check > 0:
            window.blit(check_message, (250, 290))
